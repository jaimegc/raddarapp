...
public class MockWebServerTest {
    ...
    protected void enqueueMockResponseEmptyBody() throws IOException {
        enqueueMockResponseEmptyBody(200);
    }
    ...
    protected void enqueueMockResponseEmptyBody(int code) throws IOException {
        MockResponse mockResponse = new MockResponse();
        String fileContent = "{ \"empty\": \"empty\"}";
        mockResponse.setResponseCode(code);
        mockResponse.setBody(fileContent);
        server.enqueue(mockResponse);
    }
    ...
    protected String getContentFromFile(String fileName) throws IOException {
        ...
        // If this doesn't work, use the commented line
