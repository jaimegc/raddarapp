...
public class FootprintRankingViewModel implements FootprintRankingViewModelContract {
    ...
    public FootprintRankingViewModel(String key, String title, String media, String userKey, String username, String userImage,
