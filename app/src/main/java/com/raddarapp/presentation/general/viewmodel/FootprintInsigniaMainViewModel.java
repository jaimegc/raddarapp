...
public class FootprintInsigniaMainViewModel implements FootprintMainViewModelContract {
    ...
    public FootprintInsigniaMainViewModel(String key, String title, String media, String userKey, String username, String userImage,
            ...
            long likes, long dislikes, int type, boolean visible, String zoneName, String parentZoneName, String countryEmoji,
            boolean powerSelected) {
        this.key = key;
        this.title = title;
        this.media = media;
