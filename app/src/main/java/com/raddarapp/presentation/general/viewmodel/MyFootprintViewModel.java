...
public class MyFootprintViewModel implements MyFootprintViewModelContract {
    ...
    public MyFootprintViewModel(String key, String title, String media, String creationMoment, int mediaType,
            int visibility, int aspectRatio, int sponsored, long comments, long likes, long dislikes,
            long scope, int category, int level, double latitude, double longitude, int type, boolean visible,
            String zoneName, String parentZoneName, String countryEmoji, int status) {
        this.key = key;
        this.title = title;
        this.media = media;
