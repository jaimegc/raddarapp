...
public class MyLeaderKingRankingViewModel implements MyUserRankingViewModelContract {
    ...
    public MyLeaderKingRankingViewModel(String key, String username, String image, String audio, String range,
