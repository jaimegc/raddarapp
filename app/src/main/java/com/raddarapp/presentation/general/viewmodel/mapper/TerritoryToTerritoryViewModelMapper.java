...
public class TerritoryToTerritoryViewModelMapper extends Mapper<Territory, TerritoryViewModelContract> {

    @Inject
    public TerritoryToTerritoryViewModelMapper() {}
    ...
    public TerritoryViewModelContract map(Territory territory) {
        ...
        final TerritoryViewModel territoryViewModel = new TerritoryViewModelBuilder()
                ...
                .withLeaderLevel(territory.getLeader() != null ? String.valueOf(territory.getLeader().getLevel()) : "")
