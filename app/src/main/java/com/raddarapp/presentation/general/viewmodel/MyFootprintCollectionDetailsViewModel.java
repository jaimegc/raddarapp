...
public class MyFootprintCollectionDetailsViewModel implements MyFootprintCollectionDetailsViewModelContract {
    ...
    public MyFootprintCollectionDetailsViewModel(String key, String media, String title, String description, String views,
