...
public abstract class BasePresenterNormal<T extends BasePresenterNormal.View>
        extends RosiePresenter<T> {

    public BasePresenterNormal(UseCaseHandler useCaseHandler) {
    ...
    public interface View extends RosiePresenter.View, BasePresenterErrorsContract {
