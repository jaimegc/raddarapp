...
public class FootprintRankingDetailsViewModel implements FootprintRankingDetailsViewModelContract {
    ...
    public FootprintRankingDetailsViewModel(String key, String media, String title, String description, String views,
