...
public class FootprintMainViewModel implements FootprintMainViewModelContract {
    ...
    public FootprintMainViewModel(String key, String title, String media, String userKey, String username, String userImage,
