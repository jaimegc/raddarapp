...
public class StableAspectAnyUserFootprintCardView extends CardView {

    private int aspectWidth = 260;
    private int aspectHeight = 324;

    public StableAspectAnyUserFootprintCardView(Context context) {
        this(context, null, 0);
    }

    public StableAspectAnyUserFootprintCardView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StableAspectAnyUserFootprintCardView(Context context, AttributeSet attrs, int defStyleAttr) {
