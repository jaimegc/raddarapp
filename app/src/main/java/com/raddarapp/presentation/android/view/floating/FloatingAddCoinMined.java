...
public class FloatingAddCoinMined {
    private FloatingDecorTextView mFloatingDecorView;
    private SpringSystem mSpringSystem;
    private Activity activity;

    public FloatingAddCoinMined(Activity activity){
    ...
    public void startFloating(FloatingElement floatingElement) {
        ...
        int topMargin = rect.top  + anchorView.getHeight();
        int leftMargin = rect.left  - (int) (anchorView.getWidth() / 2.4);
