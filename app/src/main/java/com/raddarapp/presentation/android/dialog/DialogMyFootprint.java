...
public class DialogMyFootprint extends DialogFragment {
    ...
    public static String TAG = "DialogMyFootprint";
    ...
    private DialogMyFootprint(Context context, OnDialogMyFootprintsListener onDialogMyFootprintsListener) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_my_footprint, null);
    ...
    public static void open(Context context, FragmentManager fm, OnDialogMyFootprintsListener onDialogMyFootprintsListener) {
        DialogMyFootprint dialogComingSoon = new DialogMyFootprint(context, onDialogMyFootprintsListener);
    ...
    private boolean deleteMyFootprint() {
        onDialogMyFootprintsListener.onMyFootprintDeleted();
        dismiss();
