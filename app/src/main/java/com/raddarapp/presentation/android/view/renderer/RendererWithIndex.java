 ...
 */
public abstract class RendererWithIndex<T> implements Cloneable {
    ...
    /**
     * @return the element position stored in the Renderer.
     */
    ...
    /**
     * Configures the element position stored in the Renderer.
     *
     * @param position associated to the Renderer instance.
     */
     ...
     */
    protected RendererWithIndex copy() {
        RendererWithIndex copy = null;
        try {
            copy = (RendererWithIndex) this.clone();
