...
public class StableAspectAnyUserFootprintRelativeLayout extends RelativeLayout {

    private int aspectWidth = 260;
    private int aspectHeight = 324;

    public StableAspectAnyUserFootprintRelativeLayout(Context context) {
        this(context, null, 0);
    }

    public StableAspectAnyUserFootprintRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StableAspectAnyUserFootprintRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
