...
public class LoadMoreMyFootprintsCollectionRenderer extends BaseRendererWithIndex<MyFootprintCollectionViewModelContract> {

    private static final String FONT_NAME = BuildConfig.BASE_FONT_NAME;

    private Context context;

    public LoadMoreMyFootprintsCollectionRenderer(Context context) {
