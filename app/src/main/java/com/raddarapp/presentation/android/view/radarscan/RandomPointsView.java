 ...
 */
public class RandomPointsView extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener
{

    private static final String tag = RandomPointsView.class.getSimpleName();
    ...
    public RandomPointsView(Context context)
    {
        super(context);
        init(null, context);
        sizePoint = dip2px(context, 10);
    }

    public RandomPointsView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init(attrs, context);
        sizePoint = dip2px(context, 10);
    ...
    public RandomPointsView(Context context, AttributeSet attrs, int defStyleAttr)
    {
                               ...
                               int yItem)
    {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            FrameLayout.LayoutParams layParams = new FrameLayout.LayoutParams(sizePoint, sizePoint);
