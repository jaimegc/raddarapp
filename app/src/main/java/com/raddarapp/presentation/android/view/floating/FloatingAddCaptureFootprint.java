...
public class FloatingAddCaptureFootprint {
    private FloatingDecorTextView mFloatingDecorView;
    private SpringSystem mSpringSystem;
    private Activity activity;

    public FloatingAddCaptureFootprint(Activity activity){
    ...
    public void startFloating(FloatingElement floatingElement, String reachValue, String fontName) {
        ...
        TextView reachView = ((TextView) targetView.getRootView().findViewById(R.id.total_scope));
