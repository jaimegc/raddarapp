...
public class MyFootprintCollection implements Identifiable<String> {
    ...
    public MyFootprintCollection(String key, String media, String title, String description, long comments,
            ...
            String zoneName, String parentZoneName, String countryEmoji, int status, RaddarLocation raddarLocation, User user) {
        this.key = key;
        this.media = media;
        this.title = title;
